...
UPSTREAM_REF = os.getenv('COINCURVE_UPSTREAM_REF') or '4e3d181d7a15e028069a08e6abcd35eb69f12e02'

LIB_TARBALL_URL = f'https://github.com/devos50/secp256k1-zkp/archive/{UPSTREAM_REF}.tar.gz'
