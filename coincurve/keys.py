...
class PrivateKey:
    ...
    def schnorr_sign(self, message: bytes) -> bytes:
        ...
        signed = lib.secp256k1_schnorrsig_sign_custom(self.context.ctx, signature, message, len(message), keypair, ffi.NULL)
...
class PublicKey:
    ...
    def schnorr_verify(self, signature: bytes, message: bytes) -> bool:
        ...
        verified = lib.secp256k1_schnorrsig_verify(self.context.ctx, signature, message, len(message), xonly_pubkey)
